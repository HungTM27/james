...
// hiển thị danh mục
$sqlCate = "select * from categories where status=1 order by id desc limit 3";
$categories = executeQuery($sqlCate, true);
                            ...
                            <div class="part-2">
                                <div class="search-box" >
                                    <form action="search.php" method="post">
                                        ...
                                        <button type="submit" id="btnsearch" class="btn btn-search" name = 'post_search' value="search">
                ...
                <div class="col-md-2 col-sm-3" >
                    <div class="dashboard" style="width: 235px; " >
                        ...
                        if ($user == '') {
                            ...
                            <div class="account-menu" >
                                <ul style="">
                                    <li style="width: 85px;"><a href="admin1/">Quản&nbsp;Trị</a></li>
                                    <li style="width: 95px;"><a href="myaccount.php">Tài&nbsp;Khoản</a></li>
                                </ul>
                            </div>
                            <?php
                    ...
                    <div class="mainmenu">
                        <nav>
                            <ul>
                                ...
                                <li><a href="<?php echo BASE_URL . "shop.php?id=" . $categories['id'] ?>"><?php echo $categories['name'] ?></a></li>
                                <?php endforeach ?>
