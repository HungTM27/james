                    ...
                    <div class="product-list">
                        <div class="product-img">
                          <a href="<?php echo BASE_URL . "single-product.php?id=" . $rating['id'] ?>">
                                <img width="300" height="200" src="<?php echo $rating['feature_image'] ?>" alt="" />
                            </a>
                        </div>
                        <br>
        ...
        <div class="row">
            <?php foreach ($products as $pro): ?>
                <div class="col-md-3">
                    ...
                    <div class="product-list">
                        <div class="product-img">
                            <a href="<?php echo  "single-product.php?id=" . $pro['id'] ?>">
                                <img width="300" height="200" src="<?php echo $pro['feature_image'] ?>" alt="" />
                           </a>
                        </div>
                        <br>
                        <div class="product-title">
