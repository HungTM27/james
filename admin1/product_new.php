         ...
         <form role="form" method="POST" enctype="multipart/form-data" action="post_product.php">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="name" placeholder="Mã sản phẩm " type="text" name="sku" readonly >
            </div>
            ...
            <div class="form-group">
              ...
              <select name="cate_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" name="categories">
                ...
                while($rowDm = mysqli_fetch_assoc($resultDm)){
                 ?>
                 <option value="<?php echo $rowDm['id']; ?>"><?php echo $rowDm['name']; ?></option>
                 <?php 
               }
               ?>
              </select>
            ...
            <!-- <div class="form-group">
                ...
                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" name="categories">
                <?php 
                  while($rowDm = mysqli_fetch_assoc($resultDm)){

                 ?>
                  <option value="<?php echo $rowDm['id_cate']; ?>"><?php echo $rowDm['name']; ?></option>
                  <?php 
                    }
                   ?>
                </select>-->
