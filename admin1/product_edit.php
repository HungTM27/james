...
<?php 
  $sqlDm = "SELECT * FROM categories WHERE id_categories > 0";
    ...
    <div class="col-xs-12">
      <div class="box">
        ...
        <div class="box-body">
         ...
         <form role="form" method="POST" action="post_edit_product.php?id=<?= $product['id']; ?>" enctype="multipart/form-data">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <select name="catalog" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true">
                <?php 
                while($rowDm = mysqli_fetch_assoc($resultDm)){
                 ?>
                 <option value="<?php echo $rowDm['id_categories']; ?>"><?php echo $rowDm['name_categories']; ?></option>
                 <?php 
               }
               ?>
             </select>
